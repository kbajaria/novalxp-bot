...
- `site_navigation` -> `us.amazon.nova-lite-v1:0`
- `course_recommendation` -> `us.amazon.nova-pro-v1:0`
- `section_explainer` -> `us.amazon.nova-pro-v1:0`
- Error/timeout fallback -> `us.anthropic.claude-haiku-4-5-20251001-v1:0`
